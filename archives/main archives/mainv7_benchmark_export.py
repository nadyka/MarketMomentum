...
# If the checkbox is checked, add a text input for the benchmark symbol
...
if st.session_state['page'] == 'Custom Report':
    ...
    graph_functions = {
        'Daily Returns Graph': lambda stock: qsf.plot_daily_returns(stock, benchmark, benchmark_symbol),
