...
from modules import qs_functions_beta as qsf
import time
...
if st.session_state['page'] == 'Custom Report':
    ...
    # After rendering the HTML snapshot, set 'html_rendered' to True
    st.session_state['html_rendered'] = True

# Only show the 'Analyze Stock' button if 'html_rendered' is True
if 'html_rendered' in st.session_state and st.session_state['html_rendered']:
    if st.button('Analyze Stock'):
        result = qsf.analyze_stock(stock)
        st.write(result)
