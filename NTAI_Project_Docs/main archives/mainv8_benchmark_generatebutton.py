...
if st.session_state['page'] == 'Custom Report':
    ...
    # Modify the function mappings to pass the benchmark to the functions
        graph_functions = {
                ...
                'Earnings Graph': lambda stock: qsf.plot_earnings(stock, benchmark, benchmark_symbol),
                'Monthly Distribution Graph': qsf.plot_monthly_dist,
                'Log Returns Graph': lambda stock: qsf.plot_log_returns(stock, benchmark, benchmark_symbol),
